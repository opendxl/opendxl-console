...
var libs = 
	[
        "schema/GmailMessageDS.ds.xml",
        "schema/GmailAttachmentDS.ds.xml"
	];
...
(function () {
    ...
    loadLib("language/startDefiningFramework", "#module=Gmail");
    for (var i = 0, l = libs.length; i < l; ++i) {
        if (!libs[i]) continue;
        if (window.UNSUPPORTED_BROWSER_DETECTED == true) break;
        loadLib(libs[i]);
    }
    loadLib("language/stopDefiningFramework", "#module=Gmail");
})();
