...
//        driver.get("isomorphic/system/reference/SmartClient_Explorer.html#upload", true);
//
...
isc.AutoTest.addClassMethods({
    ...
    getNearestDescendantElement : function (xCoords, yCoords, rootElement, rootX, rootY) {
        ...
        for (var i = 0; i < nCoords; i++) {
            ...
            // skip any points that aren't descendants
...
isc.ApplyAutoTestMethods = function () {
    ...
    if (isc.AutoTest.methodsApplied) return;
...
if (isc.DrawPane) {
    ...
    isc.DrawItem.addMethods({
        ...
        getLocatorInternal : function drawItem_getLocatorInternal (ignoreTestRoot,
                                                                   skipAbsoluteLocator)
        {
            var drawPane = this.drawPane;
            return drawPane.getLocatorInternal(ignoreTestRoot, skipAbsoluteLocator) + "/" +
                drawPane.getItemLocator(this);
        },
...
if (isc.DateChooser) {
    ...
    // allow us to detect whether ApplyAutoTestMethods() has run
    isc.AutoTest.methodsApplied = true;
...
isc.AutoTest.addClassMethods({
    ...
    isFormDone : function (element, strictMode) {
        ...
        for (var i = 0; i < itemsToCheck.length; i++) {
            ...
            var itemDone = this.isItemDone(item, strictMode);
    ...
    isItemDone : function (element, strictMode, skipContainerCheck) {
        ...
        for (var i = 0; i < subItems.length; i++) {
            if (isc.isA.FormItem(subItems[i]) && 
