...
/*
  ...
  Version v11.1p_2017-08-20/LGPL Deployment (2017-08-20)
...
if (window.isc && isc.version != "v11.1p_2017-08-20/LGPL Deployment" && !isc.DevUtil) {
    isc.logWarn("SmartClient module version mismatch detected: This application is loading the core module from "
        + "SmartClient version '" + isc.version + "' and additional modules from 'v11.1p_2017-08-20/LGPL Deployment'. Mixing resources from different "
...
isc.TabBar.addProperties({
    ...
    //>    @attr    isc.TabBar.skinImgDir        (SCImgURL : "images/Tab/" : AIRW)
...
isc.TabSet.addProperties({
    ...
    //> @attr tab.name (TabName : null : IRW)
